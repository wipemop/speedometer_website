<template>
  <div
      class="bg-black-1000 bg-opacity-90  min-h-screen flex flex-col bg-cover bg-center"
  ...
  >
    ...
    <main class="flex-grow container mx-auto px-4 py-12 space-y-12">
      ...
      <div class="bg-black-1000 text-yellow-300 font-bold">
        <div class="container mx-auto px-4 py-12 text-center">
          <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-black-900 p-6 rounded-xl shadow-xl border-4 border-orange-700">
            ...
            <div class="bg-black-900 p-6 rounded-xl shadow-xl border-4 border-black-900">
          ...
          <div class="mt-12">
            <a href="https://github.com/wipemop/simple_speedometer" class="px-8 py-4 bg-red-600 text-white text-xl rounded-lg shadow-lg hover:bg-red-700">Download Now</a>
          </div>
        </div>
      </div>

      <!-- Online Configuration Tool Section -->
      <section class="bg-black-900 bg-opacity-90 p-8 rounded-lg shadow-lg">
      ...
      <section class="text-center">
        <div class="bg-black-900 bg-opacity-90 p-8 rounded-lg shadow-lg inline-block">
