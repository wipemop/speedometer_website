<template>
  <div
      class="bg-black-950 bg-opacity-90  min-h-screen flex flex-col bg-cover bg-center"
  ...
  >
    ...
    <main class="flex-grow container mx-auto px-4 py-12 space-y-12">
      ...
      <div class="bg-black-950 text-yellow-300 font-bold">
      ...
      <section class="bg-black-800 bg-opacity-90 p-8 rounded-lg shadow-lg">
      ...
      <section class="text-center">
        <div class="bg-black-800 bg-opacity-90 p-8 rounded-lg shadow-lg inline-block">
