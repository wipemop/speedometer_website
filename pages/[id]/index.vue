  ...
  <div class="min-h-screen text-white bg-black">
    ...
    <div v-for="(set, setName) in config.Sets" :key="setName" class="" v-else>
      ...
      <div v-if="expanded === set" class="bg-neutral-900 p-5">
        ...
        <div class="grid grid-cols-4 gap-2">
          <label class="text-orange-600">X: <input type="number" v-model.number="set.End.x" class="border-b px-2 py-1 w-full bg-neutral-700"></label>
          <label class="text-orange-600">Y: <input type="number" v-model.number="set.End.y" class="border-b px-2 py-1 w-full bg-neutral-700"></label>
          <label class="text-orange-600">Z: <input type="number" v-model.number="set.End.z" class="border-b px-2 py-1 w-full bg-neutral-700"></label>
          <label class="text-orange-600">Radius: <input type="number" v-model.number="set.Endradius" class="border-b px-2 py-1 w-full bg-neutral-700"></label>
        </div>
        ...
        <div @dragover.prevent @drop="dropCheckpoint(setName, $event)">
          <div v-for="(checkpoint, index) in set.Checkpoints" :key="index"
            ...
            <label class="py-2 text-orange-600">X: <input type="number" v-model.number="checkpoint.Position.x" class="border-b px-2 py-2 w-full bg-neutral-700"></label>
            <label class="py-2 text-orange-600">Y: <input type="number" v-model.number="checkpoint.Position.y" class="border-b px-2 py-2 w-full bg-neutral-700"></label>
            <label class="py-2 text-orange-600">Z: <input type="number" v-model.number="checkpoint.Position.z" class="border-b px-2 py-2 w-full bg-neutral-700"></label>
            <label class="py-2 text-orange-600">Radius: <input type="number" v-model.number="checkpoint.Radius" class="border-b px-2 py-2 w-full bg-neutral-700"></label>
